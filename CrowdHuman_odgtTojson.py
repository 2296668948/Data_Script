...
'''
 ———————————————— 
原文链接：https://blog.csdn.net/qq_41375609/article/details/95202218
'''
...
def crowdhuman2coco(odgt_path, json_path):  # 一个输入文件路径，一个输出文件路径
    ...
    for i in range(record_list):
        ...
        im = Image.open("/data/crowd/Images/" + file_name)
...
if __name__ == '__main__':
    odgt_path = 'E:/yjy/annotation_train.odgt'
    json_path = 'E:/yjy/json/train.json'
