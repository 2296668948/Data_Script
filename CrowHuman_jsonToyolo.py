...
def crowdhuman2coco(odgt_path, json_path):  # 一个输入文件路径，一个输出文件路径
    ...
    for i in range(record_list):
        ...
        im = Image.open("E:/yjy/Crowhunman/train_image/" + file_name)
...
if __name__ == '__main__':
    json_dict = 'D:/行人检测/code/YOLOv5-Tools-main/CrowHuman2YOLO/data/raw/train.json'
    odge_path = 'D:/行人检测/code/YOLOv5-Tools-main/CrowHuman2YOLO/data/raw/annotation_train.odgt'
